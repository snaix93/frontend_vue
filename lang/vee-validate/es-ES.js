const custom = {
    path: {
      regex: 'Por favor ingrese solo la ruta de su página o script.',
    },
};
...
const messages = {
  ...
  regionInSelection: 'Por favor seleccione una región.',
  uniqueTokenName: 'Ya hay una ficha con ese nombre.',
  uniqueRules: 'Ya hay una regla con estos valores.',
  invitationCode: 'Este pase VIP no es válido.',
};
